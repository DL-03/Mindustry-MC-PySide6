...
"")
        ...
        self.color_vis.setMinimumSize(QtCore.QSize(0, 25))
        self.color_vis.setMaximumSize(QtCore.QSize(16777215, 25))
...
"")
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.LabelRole, self.lbl_alpha)
        ...
        self.formLayout.setWidget(3, QtWidgets.QFormLayout.ItemRole.FieldRole, self.alpha)
        ...
        self.lbl_alpha.setBuddy(self.alpha)
        ...
        ColorPicker.setTabOrder(self.blue, self.alpha)
    ...
    def retranslateUi(self, ColorPicker):
        ...
        self.hex.setText(_translate("ColorPicker", "ffffffff"))
